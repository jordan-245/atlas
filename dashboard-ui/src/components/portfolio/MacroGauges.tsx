...
export function MacroGauges({ data }: Props) {
  return (
    <details className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl" open>
      ...
      <div className="p-5 pt-0 grid grid-cols-3 lg:grid-cols-2 sm:grid-cols-1 gap-4">
