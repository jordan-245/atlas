      ...
      <div className="max-w-[1440px] mx-auto h-full px-6 flex items-center gap-6">
        ...
        {regimeLoading ? (
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-[var(--color-text-muted)]">Dynamic sizing</span>
          </div>
        )}

        {/* MarketClock */}
        <span className="text-sm text-[var(--color-text-muted)] font-mono">{clockString}</span>
        ...
        <a
          href="/homerbot"
          className="text-sm text-[var(--color-text-muted)] hover:text-[var(--color-text)] flex items-center gap-1.5"
        >
          ◈ Homerbot
        </a>
